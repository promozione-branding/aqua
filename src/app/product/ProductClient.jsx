...
export default function ProductPage() {
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-12 gap-12">
          ...
          <div className="col-span-6">
            <div className="relative rounded-2xl border border-slate-200 aspect-[4/5] flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-blue-50 to-blue-100">
              ...
              <button
                ...
                onClick={() =>
                  setActiveThumb(
                    (p) => (p - 1 + thumbnails.length) % thumbnails.length,
                  )
                }
              >
              ...
              <button
                ...
                onClick={() =>
                  setActiveThumb((p) => (p + 1) % thumbnails.length)
                }
              >
          ...
          <div className="col-span-6">
            ...
            <p className="text-slate-500 mt-3.5">Premium ABS RO Cabinet</p>
            ...
            <p className="text-base text-slate-600 leading-relaxed mt-6">
              Aqua Smart Cabinet is made from high-quality ABS food grade
              material with elegant design and superior finish. It is suitable
              for all types of RO systems and ensures long-lasting performance
              and durability.
            </p>

            <div className="mt-6 rounded-xl border border-slate-200 overflow-hidden">
              <div className="bg-blue-50 px-5 py-3 border-b border-slate-200">
                <h3 className="text-sm font-bold text-blue-950 tracking-wide">
                  KEY SPECIFICATIONS
                </h3>
              </div>
            ...
            <div className="flex  gap-3 mt-6">
              <button className="flex items-center text-base justify-center gap-2 bg-green-500 border border-slate-300 text-black font-semibold  rounded-lg px-4 py-3 hover:border-green-500 hover:scale-105 duration-150 transition">
                <FaWhatsapp size={23} className="" />
                WHATSAPP US
              </button>
      ...
      <section className="bg-white border-y border-slate-200 py-14">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center gap-3 mb-8">
            <h2 className="text-lg font-extrabold text-blue-950 tracking-wide">
              PRODUCT FEATURES
            </h2>
          ...
          <div className="">
            <div className="flex items-center gap-8 border-b border-slate-200">
              {[
                ...
                <button
                  ...
                  className={`text-base pb-3.5 border-b-2 transition ${
                    activeTab === tab.key
            ...
            <div className="pt-6">
              <p className="text-lg text-black leading-relaxed">
                Aqua Smart Cabinet is designed to provide premium look,
                durability and best protection for your RO system. Manufactured
                using food grade ABS material, it is 100% rust proof and leak
                proof. Its modern design fits perfectly in every home and office
                environment.
              </p>
              ...
              <ul className="mt-5 space-y-3">
                {checklist.map((item) => (
                  ...
                  >
                    <CheckCircle2
                      className="w-4 h-4 text-black mt-1.5 text-blue-500 shrink-0"
                      strokeWidth={2}
                    />
                    {item}
                  </li>
  ...
  <div className="relative flex min-h-[340px] flex-col overflow-hidden rounded-2xl bg-gradient-to-br from-blue-950 to-blue-800 p-7">
    ...
    <div className="relative z-10 flex h-full flex-1 flex-col pr-[170px]">
      ...
      <button className="mt-auto w-fit rounded-lg bg-white px-5 py-3 text-xs font-bold tracking-wide text-blue-950 transition hover:bg-blue-50">
        CONTACT US NOW
      </button>
    </div>
    ...
    />
      ...
      <section className="bg-white py-14 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-extrabold text-blue-950 tracking-wide">
              YOU MAY ALSO LIKE
            </h2>
      ...
      <section className="bg-blue-950 py-8">
        <div className="max-w-7xl mx-auto px-0 flex items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8 text-white">
            {perks.map(({ icon: Icon, label }) => (
              <div key={label} className="flex items-center gap-2.5">
                <Icon className="w-14 h-14 text-blue-200" strokeWidth={1.6} />
