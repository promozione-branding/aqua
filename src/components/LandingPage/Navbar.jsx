...
export default function Navbar() {
  ...
  return (
    <>
      {/* ================= TOP BAR ================= */}
      {/* FIXED: Lowered z-index to 40 so the header/mobile menu can sit above it */}
      ...
      {/* ================= MAIN NAVIGATION ================= */}
      {/* FIXED: Removed conflicting 'relative' class and set z-index to 50 */}
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="h-[72px] lg:h-[86px] flex items-center justify-between">
            ...
            <button
              ...
              className="lg:hidden p-2 -mr-2 text-slate-900 hover:text-blue-600 transition-colors z-50"
            >
              ...
              >
                ...
                <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-2">
                  ...
                  <div className="border-b border-slate-100">
                    <button
                      ...
                      className="flex items-center justify-between w-full py-3 text-[16px] font-bold text-slate-800 uppercase tracking-wide"
                    >
                      <span>Products</span>
                      <ChevronDown
                        size={20}
                        className={`transition-transform duration-300 ${
                          isMobileProductsOpen ? "rotate-180 text-blue-600" : "text-slate-400"
                        }`}
                      />
                    </button>
                        ...
                        >
                          <div className="pb-4 pt-1 space-y-4">
                                    ...
                                    <div className="mt-4 pt-4 border-t border-slate-200">
                                      ...
                                      <div className="flex gap-3 overflow-x-auto pb-2 custom-scrollbar snap-x">
                                        {subcategories.map((sub) => (
                                          ...
                                          >
                                            <div className="w-14 h-14 bg-white rounded-full border border-slate-200 flex items-center justify-center p-2 shadow-sm">
                                              <img
                                                src={sub.image || "/3.png"}
                                                alt={sub.name}
                            ...
                            <Link
                              href="/products"
                              onClick={() => setIsMobileMenuOpen(false)}
                              className="flex items-center justify-center w-full py-3 bg-blue-50 text-blue-700 font-bold text-sm uppercase rounded-xl"
                            >
                              View All Products
                            </Link>
                          </div>
                ...
                <div className="p-6 border-t border-slate-100 bg-slate-50 mt-auto">
                  <Link
                    href="/"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="flex items-center justify-center bg-[#0D3B8E] text-white font-bold uppercase text-[14px] w-full h-12 rounded-xl shadow-md"
                  >
                    Get Price List
                  </Link>
                  <a
