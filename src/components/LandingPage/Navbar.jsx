        ...
        >
          ...
          <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-2">
            <Link
              href="/"
              onClick={() => setIsMobileMenuOpen(false)}
              className="py-3 text-[16px] font-bold text-slate-800 uppercase tracking-wide border-b border-slate-100"
            >
              Home
            </Link>
            <Link
...
export default function Navbar() {
      ...
      try {
        ...
        if (prodRes.data.success) {
          ...
          if (roProd?.colorVariants?.[0]?.images?.[0]?.url) {
            setRoCabinetImage((prev) =>
              prev && prev !== "/1.png"
                ? prev
                : roProd.colorVariants[0].images[0].url,
            );
          }
        }
      } catch (error) {
  ...
  const activeCategory =
    staticCategories.find((c) => c.id === activeCategoryId) ||
    staticCategories[0];
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="h-[72px] lg:h-[86px] flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center gap-8 font-semibold text-[15px] text-gray-800 uppercase tracking-wide">
              ...
              <Link href="/about" className="hover:text-[#0D3B8E] transition">
                About Us
              </Link>
                    ...
                    <div className="col-span-7 flex flex-col justify-between pl-2">
                      <div>
                        ...
                        <div className="flex items-center justify-between pb-3 mb-4 border-b border-slate-100">
                          ...
                          <Link
                            href="/products"
                            className="text-xs font-semibold text-blue-600 hover:text-blue-800 transition normal-case"
                          >
                            View All
                          </Link>
                        </div>
                              ...
                              >
                                ...
                                >
                                  <div className="flex items-center gap-3">
                                    <div
                                      className={`p-2 rounded-lg ${isActive ? "bg-white text-blue-600" : "bg-slate-100 text-slate-600 group-hover/cat:bg-white group-hover/cat:text-blue-600"} transition`}
                                    >
                                      <Icon
                                        size={18}
                                    ...
                                    <div>
                                      <span
                                        className={`font-semibold text-sm ${isActive ? "text-blue-700" : "text-slate-700"} group-hover/cat:text-blue-700`}
                                      >
                                        {category.name}
                                      </span>
                                    </div>
                                  ...
                                  <ChevronRight
                                    ...
                                    className={`transition-all ${
                                      isActive
                                        ...
                                        : "text-slate-300 opacity-0 -translate-x-2 group-hover/cat:opacity-100 group-hover/cat:translate-x-0"
                                    }`}
                                  />
                                </Link>
                              </div>
                      ...
                      <div className="mt-4 pt-3 border-t border-slate-100">
                        <Link
                          href="/products"
                          className="group/all flex items-center justify-between px-4 py-2.5 rounded-xl bg-blue-50 hover:bg-blue-600 text-blue-700 hover:text-white transition-all duration-300"
                        >
